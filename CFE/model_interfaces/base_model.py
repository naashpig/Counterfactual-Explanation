"""Module containing a template class as an interface to ML model.
   ...
   All model interface methods are in CFE.model_interfaces"""

import pickle
import numpy as np
from CFE.utils.helpers import DataTransfomer

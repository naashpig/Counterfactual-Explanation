...
from CFE.explainer_interfaces.feasible_base_vae import FeasibleBaseVAE
from CFE import diverse_counterfactuals as exp
from CFE.utils.sample_architecture.vae_model import CF_VAE
from CFE.utils.helpers import get_base_gen_cf_initialization
...
class FeasibleModelApprox(FeasibleBaseVAE, ExplainerBase):
    ...
    def __init__(self, data_interface, model_interface, **kwargs):
        ...
        #Data paths
        self.base_model_dir= '../../CFE/utils/sample_trained_models/'
